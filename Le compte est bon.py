...
lis=[]
texte_instruction = tk.Label(fenetre, text="Veuillez sélectionner deux chiffres, un opérateur, puis cliquez sur 'Calculer'.", bg="blue", fg="white", font=("Arial", 12))
texte_instruction.pack()
